...
Please [open an issue](https://github.com/serokell/nyan-interpolation/issues/new/choose)
if you find a bug or have a feature request.
Before submitting a bug report or feature request, check to make sure it hasn't already been submitted.

Also, check the [design decisions document](/docs/design-decisions.md) on your topic, this way we will be able to come to a common conclusion quicker.
